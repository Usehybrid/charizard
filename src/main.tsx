...
const filtersV2 = {
  header: [
    {
      id: 'device-allocated_to',
      name: 'Allocated to',
      key: 'filter_allocated_to',
      options: [
        {
          name: 'Sonal MDM',
          value: '4610c142-c370-4503-a95d-878d8092a37e',
          customName:
            '<div><span style="color: var(--text-primary); font-size: 14px; font-weight: 400; line-height: 20px; word-wrap: break-word">Sonal MDM<br/></span><span style="color: var(--text-secondary); font-size: 14px; font-weight: 400; line-height: 20px; word-wrap: break-word">sonal@hybr1d.io</span></div>',
        },
        {
          name: 'tanmay.khachane@hybr1d.io',
          value: 'tanmay.khachane@hybr1d.io',
          customName:
            '<div><span style="color: var(--text-primary); font-size: 14px; font-weight: 400; line-height: 20px; word-wrap: break-word">tanmay.khachane@hybr1d.io</span></div>',
        },
        {
          name: 'arnab goswami  singh',
          value: '80668f82-b45a-402a-aa49-75d2cbbe1a15',
          customName:
            '<div><span style="color: var(--text-primary); font-size: 14px; font-weight: 400; line-height: 20px; word-wrap: break-word">arnab goswami  singh<br/></span><span style="color: var(--text-secondary); font-size: 14px; font-weight: 400; line-height: 20px; word-wrap: break-word">amyush@hybr1d.io</span></div>',
        },
      ],
      config: {
  ...
  drawer: [
    {
      ...
      name: 'Compliant Status',
      key: 'filter_compliant',
      options: [
        {
          name: 'Compliant',
          value: 'true',
    ...
    },
    {
      ...
      options: [
        {
          name: 'MacOS',
          value: '0c280bc7-8c77-4ec1-9fb2-eeefc8d90391',
        },
        {
          name: 'Microsoft Windows 11 Pro',
          value: '69e9b4ee-9de4-4cfc-b205-58322103ad18',
        },
      ],
      config: {
        hideSearch: true,
    ...
    },
    {
      ...
      options: [
        {
          value: 'e772c635-3daf-4a43-a99a-2738914f4917',
          name: 'Finance',
        },
      ],
      config: {
